...
var br = (r, e, n) =>
  e in r
    ? yr(r, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (r[e] = n);
...
function or(r, e) {
  return r === e
    ? !0
    : (Vt || (Vt = document.createElement("a")), (Vt.href = e), r === Vt.href);
}
function _r(r) {
...
function Or(r) {
  if (r.fragment !== null) {
    ...
    (r.dirty = [-1]),
      ...
      r.after_update.forEach(an);
  }
}
function Lr(r) {
  const e = [],
    n = [];
  Ot.forEach((t) => (r.indexOf(t) === -1 ? e.push(t) : n.push(t))),
    n.forEach((t) => t()),
    (Ot = e);
}
const zt = new Set();
...
function F(r, e, n) {
  ...
  t && t.m(e, n),
    an(() => {
      ...
      r.$$.on_destroy ? r.$$.on_destroy.push(...i) : ot(i),
        (r.$$.on_mount = []);
    }),
    o.forEach(an);
}
...
function Tr(r, e) {
  r.$$.dirty[0] === -1 && (St.push(r), Sr(), r.$$.dirty.fill(0)),
    ...
    ((a.ctx = n
      ? n(r, e.props || {}, (g, k, ...x) => {
          ...
          return (
            a.ctx &&
              o(a.ctx[g], (a.ctx[g] = D)) &&
              (!a.skip_bound && a.bound[g] && a.bound[g](D), d && Tr(r, g)),
            k
          );
        })
      : []),
...
const Er = "4";
typeof window < "u" &&
  (window.__svelte || (window.__svelte = { v: new Set() })).v.add(Er);
function $n(r, e, n) {
  const t = r.slice();
  ...
  return {
    c() {
      (e = E("span")),
        ...
        l && l.c(),
        (s = nt()),
        v(e, "class", (o = r[6] < r[0] ? "inline" : "hidden"));
    },
    m(c, a) {
    ...
    p(c, a) {
      a & 1 &&
        o !== (o = c[6] < c[0] ? "inline" : "hidden") &&
        v(e, "class", o),
        c[6] < c[0]
          ? l || ((l = Sn()), l.c(), l.m(s.parentNode, s))
          : l && (l.d(1), (l = null));
    },
    d(c) {
    ...
    p(o, [i]) {
      if (i & 3) {
        ...
        for (s = 0; s < n.length; s += 1) {
          ...
          t[s]
            ? t[s].p(l, i)
            : ((t[s] = On(l)), t[s].c(), t[s].m(e.parentNode, e));
        }
  ...
  return {
    c() {
      ...
      (x = Z()),
        ...
        v(s, "class", "space-y-1.5 p-4"),
        v(i, "class", "h-full"),
        v(D, "class", "mt-auto"),
        v(n, "class", "hs-accordion-group w-full h-full flex flex-col"),
        v(n, "data-hs-accordion-always-open", ""),
        v(e, "id", "application-sidebar"),
        v(
          e,
          "class",
...
function Ar(r, e, n) {
  let { getTrainingData: t } = e,
    { newQuestionPage: o } = e,
    { loadQuestionPage: i } = e,
    { questionHistory: s } = e;
  const l = (c) => {
    i(c.id);
  };
  return (
    (r.$$set = (c) => {
      "getTrainingData" in c && n(0, (t = c.getTrainingData)),
        "newQuestionPage" in c && n(1, (o = c.newQuestionPage)),
        "loadQuestionPage" in c && n(2, (i = c.loadQuestionPage)),
        "questionHistory" in c && n(3, (s = c.questionHistory));
    }),
    [t, o, i, s, l]
  );
}
                      ...
                      (f.style.display = "block"),
                        ...
                        this.afterTransition(f, function () {
                          T.classList.contains("active") &&
                            ((f.style.height = ""),
                            u._fireEvent("open", T),
                            u._dispatch("open.hs.accordion", T, T));
                        });
                    },
                  },
                  {
                      ...
                      (f.style.height = "".concat(f.scrollHeight, "px")),
                        ...
                        this.afterTransition(f, function () {
                          T.classList.contains("active") ||
                            ((f.style.display = ""),
                            u._fireEvent("hide", T),
                            u._dispatch("hide.hs.accordion", T, T));
                        }),
                  ...
                  },
                  {
                    ...
                    value: function (T) {
                      ...
                      f.hasAttribute("data-hs-accordion-always-open") ||
                        f.querySelectorAll(this.selector).forEach(function (O) {
                          T !== O && u.hide(O);
                        });
                    },
                  },
                    ...
                    value: function (u) {
                      ...
                      u.classList.add("open"),
                        ...
                        document
                          ...
                          .forEach(function (O) {
                            u.closest(O.getAttribute("data-hs-collapse")) &&
            ...
            var _ = (function (A) {
              ...
              function C() {
                ...
                return (
                  ...
                  ((S = O.call(this, ".hs-dropdown")).positions = {
                    top: "top",
                    "top-left": "top-start",
                    "top-right": "top-end",
                    bottom: "bottom",
                    ...
                    return [
                      {
                        ...
                        fn: function (R) {
                          ...
                          (R.state.elements.popper.style.position = q),
                ...
                (T = [
                    ...
                    value: function () {
                      ...
                      document.addEventListener("click", function (j) {
                        ...
                        if (
                          ...
                          if (
                            (N == "false" || N == "inside") &&
                            !q.parentElement.closest(S.selector)
                          )
                            return;
                        }
                        q &&
                          (q.classList.contains("open")
                            ? S.close(q)
                            : S.open(q));
                      }),
                    ...
                    value: function (S) {
                      ...
                      this.open(R),
                        document.addEventListener(
                          "mousemove",
                          function q(B) {
                            (B.target.closest(j.selector) &&
                              B.target.closest(j.selector) !==
                                R.parentElement.closest(j.selector)) ||
                              (j.close(R),
                              document.removeEventListener("mousemove", q, !0));
                          },
                          !0,
                        );
                    },
                      ...
                      var j = this,
                        ...
                        B = function () {
                          S.classList.contains("open") ||
                            ...
                            (q.style.inset = null),
                            (q.style.position = null),
                            S._popper && S._popper.destroy());
                        };
                      R ||
                        this.afterTransition(
                          S.querySelector("[data-hs-dropdown-transition]") || q,
                          function () {
                            B();
                          },
                        ),
                        ...
                        R && B(),
                        this._fireEvent("close", S),
                        this._dispatch("close.hs.dropdown", S, S);
                  ...
                  },
                  {
                    ...
                    value: function (S) {
                      ...
                      if (q !== "static") {
                        ...
                        var N = (0, a.fi)(S, j, {
                          ...
                          modifiers: [].concat(
                            x(
                              q !== "fixed"
                                ? this.absoluteStrategyModifiers(S)
                                : [],
                            ),
                      ...
                      (j.style.margin = null),
                        j.classList.add("block"),
                        j.classList.remove("hidden"),
                        setTimeout(function () {
                          S.classList.add("open");
                        }),
                        this._fireEvent("open", S),
                        this._dispatch("open.hs.dropdown", S, S);
                    },
                  },
                  {
                    ...
                    value: function (S) {
                      ...
                      if (j)
                        return S.keyCode === 27
                          ? (S.preventDefault(), this._esc(j))
                          : S.keyCode === 40
                            ? (S.preventDefault(), this._down(j))
                            : S.keyCode === 38
                              ? (S.preventDefault(), this._up(j))
                              : S.keyCode === 36
                                ? (S.preventDefault(), this._start(j))
                                : S.keyCode === 35
                                  ? (S.preventDefault(), this._end(j))
                                  : void this._byChar(j, S.key);
                    },
                  },
                  {
                    key: "_esc",
                  ...
                  },
                  {
                    ...
                    value: function (S) {
                      var j = x(
                        S.querySelector(".hs-dropdown-menu").querySelectorAll(
                          "a",
                        ),
                      ).filter(function (R) {
                        return !R.disabled;
                      ...
                      var R = this,
                        ...
                        B = function () {
                          return q.findIndex(function (ie, re) {
                            return (
                              ie.innerText.toLowerCase().charAt(0) ===
                                j.toLowerCase() &&
                              R._history.existsInHistory(re)
                            );
                          });
                        },
                        N = B();
                      N === -1 && (this._history.clearHistory(), (N = B())),
                        N !== -1 && (q[N].focus(), this._history.addHistory(N));
                    },
                  },
                  {
                    key: "toggle",
            ...
            var L = (function (m) {
              ...
              function T() {
                ...
                return (
                  ...
                  ((u = P.call(this, "[data-hs-overlay]")).openNextOverlay =
                    !1),
                  u
                );
              }
                ...
                (p = [
                  {
                    ...
                    value: function () {
                      ...
                      document.addEventListener("click", function (f) {
                        ...
                        return C
                          ? u.close(C.closest(".hs-overlay.open"))
                          : O
                            ? u.toggle(
                            ...
                            : void (S && u._onBackdropClick(f.target));
                      }),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                      ...
                      try {
                        for (R.s(); !(f = R.n()).done; ) {
                          var q = f.value;
                          q.startsWith("hs-overlay-backdrop-open:") &&
                            (j += " ".concat(q));
                        }
                      } catch (N) {
                        R.e(N);
                      ...
                      this.getClassProperty(u, "--overlay-backdrop", "true") ===
                        ...
                        S.setAttribute("data-hs-overlay-backdrop-template", ""),
            ...
            var D = (function (L) {
              ...
              function P() {
                return (
                  ...
                  A.call(this, "[data-hs-remove-element]")
                );
              }
              return (
                (m = P),
            ...
            var D = (function (L) {
              ...
              function P() {
                ...
                return (
                  ...
                  ((T = A.call(this, "[data-hs-scrollspy] ")).activeSection =
                    null),
                  T
                );
              }
                      ...
                      document
                        ...
                        .forEach(function (u) {
                          ...
                          Array.from(C).forEach(function (j) {
                            j.getAttribute("id") &&
                              S.addEventListener("scroll", function (R) {
                                return T._update({
                                  $scrollspyEl: u,
                            ...
                            O.forEach(function (j) {
                              j.addEventListener("click", function (R) {
                                R.preventDefault(),
                                  j.getAttribute("href") !== "javascript:;" &&
                                    T._scrollTo({
                                      $scrollspyEl: u,
                                      $scrollableEl: S,
                                      $link: j,
                  ...
                  },
                  {
                    ...
                    value: function (T) {
                      ...
                      if (q <= 0 && q + B > 0) {
                        ...
                        var N = f.querySelector(
                          '[href="#'.concat(C.getAttribute("id"), '"]'),
                        );
                        if (N) {
                  ...
                  },
                  {
                    ...
                    value: function (T) {
                      ...
                      this._fireEvent("scroll", u),
                        ...
                        B.scrollTo({ top: q, left: 0, behavior: "smooth" });
                    },
                  },
                ]) && d(m.prototype, h),
                Object.defineProperty(m, "prototype", { writable: !1 }),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                ...
                (_ = [
                        ...
                        document
                          ...
                          .forEach(function (O) {
                            var C = document.querySelector(
                              O.getAttribute("hs-data-tab-select"),
                            );
                            C &&
                              C.addEventListener("change", function (S) {
                                var j = document.querySelector(
                                  '[data-hs-tab="'.concat(S.target.value, '"]'),
                                );
                                j && f.open(j);
                              });
                          });
                  ...
                  },
                  {
                    ...
                    value: function (f) {
                      ...
                      C.forEach(function (q) {
                        ...
                        R && (R.value = f.getAttribute("data-hs-tab"));
                    },
                  },
                  {
                    key: "_keyboardSupport",
                    value: function (f) {
                      ...
                      if (O) {
                        var C =
                          O.closest('[role="tablist"]').getAttribute(
                            "data-hs-tabs-vertical",
                          ) === "true";
                        return (C ? f.keyCode === 38 : f.keyCode === 37)
                          ? (f.preventDefault(), this._left(O))
                          : (C ? f.keyCode === 40 : f.keyCode === 39)
                            ? (f.preventDefault(), this._right(O))
                            : f.keyCode === 36
                              ? (f.preventDefault(), this._start(O))
                              : f.keyCode === 35
                                ? (f.preventDefault(), this._end(O))
                                : void 0;
                      }
                    },
                  },
                  {
                    ...
                    value: function (f) {
                      ...
                      if (O) {
                        var C = d(O.querySelectorAll(this.selector)).filter(
                            function (R) {
                              return !R.disabled;
                            },
                          ),
                  ...
                  },
                  {
                    ...
                    value: function (f) {
                      var O = f.closest('[role="tablist"]');
                      if (O) {
                        var C = d(O.querySelectorAll(this.selector))
                            .filter(function (R) {
                              return !R.disabled;
                            })
                            .reverse(),
                ...
                (_ = [
                  {
                    ...
                    value: function () {
                      ...
                      document.addEventListener("click", function (O) {
                        var C = O.target.closest(f.selector);
                        C &&
                          f.getClassProperty(C, "--trigger") === "focus" &&
                          f._focus(C),
                          C &&
                            f.getClassProperty(C, "--trigger") === "click" &&
                            f._click(C);
                      }),
                      ...
                      if (!f.classList.contains("show")) {
                        ...
                        (0, d.fi)(C, S, {
                          ...
                          f.addEventListener(
                            "mouseleave",
                            function R(q) {
                              (q.relatedTarget.closest(O.selector) &&
                                q.relatedTarget.closest(O.selector) == f) ||
                                (O.hide(f),
                                f.removeEventListener("mouseleave", R, !0));
                            },
                            !0,
                          );
                      }
                    ...
                    value: function (f) {
                      ...
                      if (!f.classList.contains("show")) {
                        ...
                        var q = function B(N) {
                          setTimeout(function () {
                            O.hide(f),
                              f.removeEventListener("click", B, !0),
                              f.removeEventListener("blur", B, !0);
                          });
                        };
                        f.addEventListener("blur", q, !0),
                          f.addEventListener("click", q, !0);
                      }
                    },
                  },
                  {
                      ...
                      f
                        ...
                        setTimeout(function () {
                          f.classList.add("show"),
                            O._fireEvent("show", f),
                            O._dispatch("show.hs.tooltip", f, f);
                        });
                    },
                  },
                  {
                    ...
                    value: function (D, L) {
                      window
                        ...
                        ? D.addEventListener(
                            ...
                            function m() {
                              L(),
                                D.removeEventListener("transitionend", m, !0);
                            },
                            !0,
                          )
                        : L();
                    ...
                    value: function (D, L) {
                      var m =
                          arguments.length > 2 && arguments[2] !== void 0
                            ...
                            : "",
                        h = (
                          window.getComputedStyle(D).getPropertyValue(L) || m
                        ).replace(" ", "");
                      return h;
                    },
                  },
          ...
          714: (s, l, c) => {
            ...
            function k(b) {
              return (
                typeof ShadowRoot < "u" &&
                (b instanceof a(b).ShadowRoot || b instanceof ShadowRoot)
              );
            }
            c.d(l, { fi: () => gr });
            var x = Math.max,
            ...
            function _(b) {
              return ((d(b) ? b.ownerDocument : b.document) || window.document)
                .documentElement;
            }
            function A(b) {
            ...
            function f(b) {
              var y = m(b),
                ...
                H = b.offsetHeight;
              return (
                Math.abs(y.width - $) <= 1 && ($ = y.width),
                Math.abs(y.height - H) <= 1 && (H = y.height),
            ...
            function C(b) {
              return ["html", "body", "#document"].indexOf(p(b)) >= 0
                    ...
                    (function (H) {
                      ...
                      for (
                        ...
                        if (
                          ...
                          V.perspective !== "none" ||
                          V.contain === "paint" ||
                          ["transform", "perspective"].indexOf(V.willChange) !==
                            -1 ||
                          (z && V.willChange === "filter") ||
                          (z && V.filter && V.filter !== "none")
                        )
                          return Q;
                        Q = Q.parentNode;
                      }
            ...
            function Lt(b) {
              ...
              function z(Q) {
                $.add(Q.name),
                  []
                    .concat(Q.requires || [], Q.requiresIfExists || [])
                    .forEach(function (V) {
                      if (!$.has(V)) {
                        var W = y.get(V);
                        W && z(W);
            ...
            function Te() {
              for (
                var b = arguments.length, y = new Array(b), $ = 0;
                $ < b;
                $++
              )
                y[$] = arguments[$];
            ...
            function ct(b) {
              ...
              return function (V, W, K) {
                ...
                var te,
                  ...
                  he = {
                    ...
                    setOptions: function (le) {
                      ...
                      pe(),
                        (ee.options = Object.assign({}, Q, ee.options, Ce)),
                        (ee.scrollParents = {
                          reference: d(V)
                            ? S(V)
                            : V.contextElement
                      ...
                      var ve,
                        ...
                        ye = (function (ce) {
                          ...
                          return at.reduce(function (de, ge) {
                            return de.concat(
                              ue.filter(function (be) {
                                return be.phase === ge;
                              }),
                            );
                          }, []);
                        })(
                          ((ve = [].concat(H, ee.options.modifiers)),
                          (fe = ve.reduce(function (ce, ue) {
                            var de = ce[ue.name];
                            return (
                              (ce[ue.name] = de
                                ? Object.assign({}, de, ue, {
                      ...
                      return (
                        (ee.orderedModifiers = ye.filter(function (ce) {
                          return ce.enabled;
                        })),
                        ...
                        if (Te(Ce, ve)) {
                          (ee.rects = {
                            reference: u(
                              Ce,
                              q(ve),
                              ee.options.strategy === "fixed",
                            ),
                            popper: f(ve),
                          }),
                            (ee.reset = !1),
                            (ee.placement = ee.options.placement),
                            ee.orderedModifiers.forEach(function (be) {
                              return (ee.modifiersData[be.name] = Object.assign(
                                {},
                                be.data,
                              ));
                            });
                ...
                return (
                  he.setOptions(K).then(function (le) {
            ...
            function oe(b) {
              ...
              var be,
                Me = Object.assign({ position: W }, te && He),
                Re =
                  ne === !0
                    ? (function (Ze) {
                        var Ke = Ze.x,
                  ...
                  ? Object.assign(
                      ...
                      (be.transform =
                        (ce.devicePixelRatio || 1) <= 1
                          ? "translate(" + ae + "px, " + pe + "px)"
                          : "translate3d(" + ae + "px, " + pe + "px, 0)"),
                      be),
                    )
                  : Object.assign(
                      {},
              ...
              return y === lt
                ...
                : d(y)
                  ? (function ($) {
                      var H = m($);
                      return (
                        (H.top = H.top + $.clientTop),
                        (H.left = H.left + $.clientLeft),
                        (H.bottom = H.top + $.clientHeight),
                        (H.right = H.left + $.clientWidth),
                        (H.width = $.clientWidth),
                  ...
                  : Ft(
                      (function ($) {
                        ...
                        return (
                          P(V || z).direction === "rtl" &&
                            (te += x(z.clientWidth, V ? V.clientWidth : 0) - W),
            ...
            function Et(b, y) {
              ...
              var $ = y,
                ...
                fe = (function (Re, Ze, Ke) {
                  var st =
                      Ze === "clippingParents"
                        ? (function (ke) {
                            var ut = S(O(ke)),
                              Fe =
                                ["absolute", "fixed"].indexOf(P(ke).position) >=
                                  0 && g(ke)
                                  ? q(ke)
                                  : ke;
                            return d(Fe)
                              ? ut.filter(function (Ge) {
                                  return (
                                    d(Ge) && un(Ge, Fe) && p(Ge) !== "body"
                                  );
                                })
                              : [];
                          })(Re)
                    ...
                    qe = We.reduce(
                      function (ke, ut) {
                        var Fe = fn(Re, ut);
                        return (
                          (ke.top = x(Fe.top, ke.top)),
                          (ke.right = D(Fe.right, ke.right)),
                          (ke.bottom = D(Fe.bottom, ke.bottom)),
                          (ke.left = x(Fe.left, ke.left)),
                          ke
                        );
                      },
                      fn(Re, Ie),
                  ...
                  d(ve) ? ve : ve.contextElement || _(b.elements.popper),
                  V,
                  K,
                ),
                ...
                },
                {
                  ...
                  fn: function (b) {
                    ...
                    Object.keys(y.elements).forEach(function ($) {
                      ...
                      g(Q) &&
                        p(Q) &&
                        (Object.assign(Q.style, H),
                        Object.keys(z).forEach(function (V) {
                          var W = z[V];
                          W === !1
                            ? Q.removeAttribute(V)
                            : Q.setAttribute(V, W === !0 ? "" : W);
                        }));
                    });
                  },
                  effect: function (b) {
                    ...
                    return (
                      Object.assign(y.elements.popper.style, $.popper),
                      (y.styles = $),
                      y.elements.arrow &&
                        Object.assign(y.elements.arrow.style, $.arrow),
                      function () {
                        Object.keys(y.elements).forEach(function (H) {
                          var z = y.elements[H],
                            Q = y.attributes[H] || {},
                            V = Object.keys(
                              y.styles.hasOwnProperty(H) ? y.styles[H] : $[H],
                            ).reduce(function (W, K) {
                              return (W[K] = ""), W;
                            }, {});
                          g(z) &&
                            p(z) &&
                            (Object.assign(z.style, V),
                  ...
                  fn: function (b) {
                    var y = b.state,
                      ...
                      V = ze.reduce(function (ne, ee) {
                        return (
                          (ne[ee] = (function (Ee, ae, he) {
                            var pe = Be(Ee),
                              le = [re, B].indexOf(pe) >= 0 ? -1 : 1,
                              Ce =
                                typeof he == "function"
                                  ? he(Object.assign({}, ae, { placement: Ee }))
                                  : he,
                              ve = Ce[0],
                              fe = Ce[1];
                            return (
                      ...
                      te = W.y;
                    y.modifiersData.popperOffsets != null &&
                      ((y.modifiersData.popperOffsets.x += K),
                      (y.modifiersData.popperOffsets.y += te)),
                      (y.modifiersData[H] = V);
                  },
                },
                {
                    ...
                    if (!y.modifiersData[H]._skip) {
                      for (
                        var z = $.mainAxis,
                          ...
                          ae = $.flipVariations,
                          he = ae === void 0 || ae,
                          pe = $.allowedAutoPlacements,
                          le = y.options.placement,
                          Ce = Be(le),
                          ve =
                            K ||
                            (Ce !== le && he
                              ...
                              : [Rt(le)]),
                          fe = [le].concat(ve).reduce(function (Ge, Xe) {
                            return Ge.concat(
                              Be(Xe) === Ye
                                ? (function (vt, ft) {
                                    ft === void 0 && (ft = {});
                        ...
                        if (
                          (Q && ke.push(We[Re] <= 0),
                          W && ke.push(We[Ie] <= 0, We[qe] <= 0),
                          ke.every(function (Ge) {
                            return Ge;
                          }))
                        ) {
                          (ge = Me), (de = !1);
                        ...
                        for (
                          var ut = function (Ge) {
                              var Xe = fe.find(function (vt) {
                                var ft = ue.get(vt);
                                if (ft)
                                  return ft.slice(0, Ge).every(function (et) {
                                    return et;
                                  });
                              });
                    ...
                    if (ue) {
                      if (Q) {
                        var Ke,
                          ...
                          vt = y.elements.arrow,
                          ft = ae && vt ? f(vt) : { width: 0, height: 0 },
                          et = y.modifiersData["arrow#persistent"]
                          ...
                          _t = Ct(0, de[Ie], ft[Ie]),
                          Yt = fe
                            ? de[Ie] / 2 - Fe - _t - Bt - Me.mainAxis
                            : Ge - _t - Bt - Me.mainAxis,
                          Jt = fe
                            ? -de[Ie] / 2 + Fe + _t + It + Me.mainAxis
                            : Xe + _t + It + Me.mainAxis,
                          ...
                          Kt = wt
                            ...
                            : 0,
                          jt =
                            (Ke = Re == null ? void 0 : Re[ye]) != null
                              ? Ke
                              : 0,
                          Nt = qe + Jt - jt,
                          kt = Ct(
                            ae ? D(ke, qe + Yt - jt - Kt) : ke,
                            qe,
                            ae ? x(ut, Nt) : ut,
                          );
                  ...
                  fn: function (b) {
                    ...
                    if (Q && V) {
                      var ne = (function (ge, be) {
                        ...
                        de = K;
                      $.modifiersData[H] =
                        (((y = {})[de] = ue), (y.centerOffset = ue - ce), y);
                    }
                  },
                  effect: function (b) {
                    var y = b.state,
                    ...
                    H != null &&
                      (typeof H != "string" ||
                        (H = y.elements.popper.querySelector(H))) &&
                      un(y.elements.popper, H) &&
                      (y.elements.arrow = H);
                  },
                  requires: ["popperOffsets"],
                ...
                },
                {
                  ...
                  fn: function (b) {
                    var y = b.state,
                      ...
                      V = Et(y, { elementContext: "reference" }),
                      W = Et(y, { altBoundary: !0 }),
                      K = gn(V, H),
                      te = gn(W, z, Q),
                      ne = hn(K),
                      ee = hn(te);
      ...
      (o.d = (s, l) => {
        for (var c in l)
          o.o(l, c) &&
            !o.o(s, c) &&
            Object.defineProperty(s, c, { enumerable: !0, get: l[c] });
      }),
      ...
      var i = {};
      return (
        o.r(i), o(661), o(795), o(682), o(284), o(181), o(778), o(51), o(185), i
      );
    })();
  });
})(Hr);
function Mr(r) {
  ...
  return {
    c() {
      (e = E("div")),
        (e.innerHTML =
          '<h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">Welcome to <span class="nav-title">Gen-AI BI Tool by GlowByte</span></h1> <p class="mt-3 text-gray-600 dark:text-gray-400">Your AI-powered copilot for SQL queries.</p>'),
        v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center");
    },
    m(n, t) {
      U(n, e, t);
    },
...
function Br(r) {
  ...
  return {
    c() {
      (e = E("p")),
        o && o.c(),
        v(e, "class", "text-gray-800 dark:text-gray-200");
    },
    m(i, s) {
    ...
    p(i, [s]) {
      o &&
        o.p &&
        (!n || s & 1) &&
        Zt(o, t, i, i[0], n ? Ut(t, i[0], s, null) : Wt(i[0]), null);
    },
    i(i) {
      n || (M(o, i), (n = !0));
    },
  ...
  return {
    c() {
      (e = E("li")),
        ...
        v(s, "class", "grow mt-2 space-y-3"),
        v(t, "class", "max-w-2xl flex gap-x-2 sm:gap-x-4"),
        v(n, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto"),
        v(e, "class", "py-2 sm:py-4");
    },
    m(k, x) {
      U(k, e, x),
        w(e, n),
    ...
    p(k, [x]) {
      const D = {};
      x & 5 && (D.$$scope = { dirty: x, ctx: k }),
        l.$set(D),
        g &&
          g.p &&
          (!a || x & 4) &&
          Zt(g, d, k, k[2], a ? Ut(d, k[2], x, null) : Wt(k[2]), null);
    },
    i(k) {
  ...
  return {
    c() {
      (e = E("div")),
        ...
        v(c, "class", "flex items-center gap-x-1"),
        v(i, "class", "flex justify-between items-center"),
        v(
          o,
          "class",
  ...
  return {
    c() {
      (e = E("div")),
        ...
        v(e, "class", "lg:hidden flex justify-end mb-2 sm:mb-3");
    },
    m(n, t) {
      U(n, e, t);
    },
  ...
  return (
    (r.$$set = (s) => {
      "message" in s && n(0, (t = s.message)),
        "onSubmit" in s && n(2, (o = s.onSubmit));
    }),
    [t, i, o]
  );
}
  ...
  return {
    ...
    p(a, [d]) {
      c &&
        c.p &&
        (!s || d & 1) &&
        Zt(c, l, a, a[0], s ? Ut(l, a[0], d, null) : Wt(a[0]), null);
    },
    i(a) {
      s || (M(c, a), (s = !0));
    },
...
function eo(r) {
  ...
  return (
    (s = new pt({
      props: { $$slots: { default: [Xr] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        (e = E("li")),
          ...
          v(
            n,
            "class",
            "flex-shrink-0 w-[2.375rem] h-[2.375rem] animate-bounce ",
          ),
          v(n, "alt", "agent logo"),
          v(i, "class", "space-y-3"),
          v(
  ...
  return {
    c() {
      (e = E("ul")),
        ...
        (d = we(`
          Download`)),
        v(o, "class", "mr-3 flex-1 w-0 truncate"),
        v(
          c,
          "d",
        ...
        v(l, "class", "flex-shrink-0 w-3 h-3"),
        v(l, "width", "16"),
        v(l, "height", "16"),
        v(l, "viewBox", "0 0 16 16"),
        ...
        v(s, "href", (g = "/api/v0/download_csv?id=" + r[0])),
        v(t, "class", "w-full flex justify-between truncate"),
        v(
          n,
          "class",
        ...
        v(e, "class", "flex flex-col justify-end text-start -space-y-px");
    },
    m(k, x) {
      U(k, e, x),
        w(e, n),
  ...
  return {
    c() {
      (e = E("th")),
        ...
        v(n, "class", "flex items-center gap-x-2"),
        v(e, "scope", "col"),
        v(e, "class", "px-6 py-3 text-left");
    },
    m(i, s) {
  ...
  return {
    c() {
      (e = E("td")),
        (n = E("div")),
        (t = E("span")),
        (t.textContent = `${r[4][r[7]]}`),
        v(t, "class", "text-gray-800 dark:text-gray-200"),
        v(n, "class", "px-6 py-3"),
        v(e, "class", "h-px w-px whitespace-nowrap");
    },
    m(o, i) {
      U(o, e, i), w(e, n), w(n, t);
    },
  ...
  return (
    (d = new oo({ props: { id: r[0] } })),
    {
      c() {
        ...
        (a = Z()),
          J(d.$$.fragment),
          v(i, "class", "bg-gray-50 dark:bg-slate-800"),
          v(c, "class", "divide-y divide-gray-200 dark:divide-gray-700"),
          v(
            o,
            "class",
            "min-w-full divide-y divide-gray-200 dark:divide-gray-700",
          ),
          v(t, "class", "p-1.5 min-w-full inline-block align-middle"),
          v(n, "class", "-m-1.5 overflow-x-auto"),
          v(
            e,
            "class",
  ...
  return {
    c() {
      (e = E("div")),
        ...
        (c = E("div")),
        (a = we(r[0])),
        v(t, "class", "flex-shrink-0"),
        v(s, "class", "text-sm text-yellow-800 font-semibold"),
        v(c, "class", "mt-1 text-sm text-yellow-700"),
        v(i, "class", "ml-4"),
        v(n, "class", "flex"),
        v(e, "class", "bg-yellow-50 border border-yellow-200 rounded-md p-4"),
        v(e, "role", "alert");
    },
    m(d, g) {
      U(d, e, g),
...
function go(r) {
  ...
  return {
    c() {
      (e = E("div")),
        o && o.c(),
        v(e, "class", "font-mono whitespace-pre-wrap");
    },
    m(i, s) {
      U(i, e, s), o && o.m(e, null), (n = !0);
    },
...
function mo(r) {
  let e, n, t, o, i, s;
  return (
    (t = new Ht({ props: { message: "Train", onSubmit: r[3] } })),
    {
      c() {
        (e = E("textarea")),
          (n = Z()),
...
function Bn(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [_o] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function In(r) {
  let e, n;
  return (
    (e = new Ht({ props: { message: r[18], onSubmit: r[3] } })),
    {
      c() {
        J(e.$$.fragment);
      },
    ...
    p(a, d) {
      if (((!i || d & 2) && e !== (e = a[1].header + "") && Ue(n, e), d & 10)) {
        ...
        for (g = 0; g < s.length; g += 1) {
          ...
          l[g]
            ? (l[g].p(k, d), M(l[g], 1))
            : ((l[g] = In(k)), l[g].c(), M(l[g], 1), l[g].m(o.parentNode, o));
        }
...
function _o(r) {
  ...
  return (
    (e = new pt({
      props: { $$slots: { default: [vo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function wo(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [jo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function xo(r) {
  let e, n, t, o, i, s, l, c;
  return (
    (e = new Mt({ props: { message: r[15].question } })),
    (t = new tt({
      props: { $$slots: { default: [Do] }, $$scope: { ctx: r } },
    })),
    (i = new tt({
      props: { $$slots: { default: [Ho] }, $$scope: { ctx: r } },
    })),
    (l = new tt({
      props: { $$slots: { default: [Mo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment),
...
function $o(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [Ro] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function So(r) {
  let e, n, t, o, i, s, l, c;
  (e = new tt({ props: { $$slots: { default: [Bo] }, $$scope: { ctx: r } } })),
    (t = new tt({
      props: { $$slots: { default: [No] }, $$scope: { ctx: r } },
    }));
  const a = [Vo, Qo],
    d = [];
  function g(k, x) {
...
function Oo(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [zo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Lo(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [Uo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function To(r) {
  ...
  return (
    (e = new tt({
      props: { $$slots: { default: [Fo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function jo(r) {
  ...
  return (
    (e = new pt({
      props: { $$slots: { default: [Co] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Ao(r) {
  ...
  return (
    (e = new dr({
      props: { $$slots: { default: [qo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Do(r) {
  ...
  return (
    (e = new pt({
      props: { $$slots: { default: [Ao] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Ho(r) {
  let e, n;
  return (
    (e = new ar({ props: { id: r[15].id, df: r[15].df } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function Ro(r) {
  let e, n;
  return (
    (e = new fr({ props: { message: r[15].error } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function Nn(r) {
  let e, n, t, o;
  return (
    (e = new Ht({ props: { message: "Yes", onSubmit: r[9] } })),
    (t = new Ht({ props: { message: "No", onSubmit: r[10] } })),
    {
      c() {
...
function No(r) {
  ...
  return {
    ...
    p(s, l) {
      const c = {};
      l & 8388608 && (c.$$scope = { dirty: l, ctx: s }),
        e.$set(c),
        s[0] === null
          ? i
            ? (i.p(s, l), l & 1 && M(i, 1))
            : ((i = Nn(s)), i.c(), M(i, 1), i.m(t.parentNode, t))
          : i &&
            (Ne(),
            I(i, 1, 1, () => {
              i = null;
...
function Qo(r) {
  let e, n;
  return (
    (e = new Mt({ props: { message: "No, the results were not correct." } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function Vo(r) {
  let e, n;
  return (
    (e = new Mt({ props: { message: "Yes, the results were correct." } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function Go(r) {
  ...
  return {
    ...
    p(a, d) {
      if (
        ((!i || d & 4) && e !== (e = a[15].header + "") && Ue(n, e), d & 12)
      ) {
        s = _e(a[15].questions);
        let g;
        for (g = 0; g < s.length; g += 1) {
          ...
          l[g]
            ? (l[g].p(k, d), M(l[g], 1))
            : ((l[g] = Qn(k)), l[g].c(), M(l[g], 1), l[g].m(o.parentNode, o));
        }
        for (Ne(), g = s.length; g < l.length; g += 1) c(g);
        Qe();
      }
...
function Uo(r) {
  ...
  return (
    (e = new pt({
      props: { $$slots: { default: [Go] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Fo(r) {
  ...
  return (
    (e = new pt({
      props: { $$slots: { default: [Wo] }, $$scope: { ctx: r } },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function Vn(r) {
  ...
  const i = [Eo, To, Lo, Oo, So, $o, xo, ko, wo],
    s = [];
  function l(c, a) {
    return c[15].type === "user_question"
      ? 0
      : c[15].type === "sql"
        ? 1
        : c[15].type === "question_list"
          ? 2
          : c[15].type === "df"
            ? 3
            : c[15].type === "plotly_figure"
              ? 4
              : c[15].type === "error"
                ? 5
                : c[15].type === "question_cache"
                  ? 6
                  : c[15].type === "user_sql"
                    ? 7
                    : 8;
    ...
    p(c, a) {
      ...
      if ((a & 32 && (d.onSubmit = c[5]), e.$set(d), a & 20)) {
        ...
        for (g = 0; g < i.length; g += 1) {
          ...
          s[g]
            ? (s[g].p(k, a), M(s[g], 1))
            : ((s[g] = Un(k)), s[g].c(), M(s[g], 1), s[g].m(t.parentNode, t));
        }
...
function Gn(r) {
  ...
  return (
    (e = new ur({ props: { message: "Re-Run SQL", onSubmit: t } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function Un(r) {
  let e,
    n,
    t = r[12].type === "question_cache" && Gn(r);
  return {
    c() {
      t && t.c(), (e = nt());
    },
    ...
    p(o, i) {
      o[12].type === "question_cache"
        ? t
          ? (t.p(o, i), i & 4 && M(t, 1))
          : ((t = Gn(o)), t.c(), M(t, 1), t.m(e.parentNode, e))
        : t &&
          (Ne(),
          I(t, 1, 1, () => {
            t = null;
    ...
    (x = P[k] = A[k](r)),
    {
      c() {
        ...
        (l = Z()),
          ...
          (g = Z()),
          x.c(),
          v(s, "class", "mt-16 space-y-5"),
          v(n, "class", "py-10 lg:py-14"),
          v(a, "class", "max-w-4xl mx-auto sticky bottom-0 z-10 p-3 sm:py-6"),
          v(e, "class", "relative h-screen w-full lg:pl-64");
      },
      m(u, f) {
        U(u, e, f),
          w(e, n),
      ...
      p(u, [f]) {
        if (
          (u[1] && u[1].type == "question_list" && !u[7]
            ? L
              ? (L.p(u, f), f & 130 && M(L, 1))
              : ((L = Bn(u)), L.c(), M(L, 1), L.m(n, i))
            : L &&
              (Ne(),
              I(L, 1, 1, () => {
                L = null;
          ...
          for (C = 0; C < m.length; C += 1) {
            ...
            h[C]
              ? (h[C].p(S, f), M(h[C], 1))
              : ((h[C] = Vn(S)), h[C].c(), M(h[C], 1), h[C].m(s, l));
          }
...
function Xo(r, e, n) {
  let { suggestedQuestions: t = null } = e,
    { messageLog: o } = e,
    { newQuestion: i } = e,
    { rerunSql: s } = e,
    { clearMessages: l } = e,
  ...
  return (
    (r.$$set = (L) => {
      "suggestedQuestions" in L && n(1, (t = L.suggestedQuestions)),
        "messageLog" in L && n(2, (o = L.messageLog)),
        "newQuestion" in L && n(3, (i = L.newQuestion)),
        "rerunSql" in L && n(4, (s = L.rerunSql)),
        "clearMessages" in L && n(5, (l = L.clearMessages)),
        "onUpdateSql" in L && n(6, (c = L.onUpdateSql)),
        "question_asked" in L && n(7, (a = L.question_asked)),
        "marked_correct" in L && n(0, (d = L.marked_correct)),
        "thinking" in L && n(8, (g = L.thinking));
    }),
  ...
  return {
    c() {
      (e = E("div")),
        ...
        (m = E("button")),
        (h = we(r[1])),
        v(i, "class", "font-bold text-gray-800 dark:text-white"),
        v(l, "type", "button"),
        v(
          l,
          "class",
        ...
        v(l, "data-hs-overlay", "#hs-vertically-centered-modal"),
        v(
          o,
          "class",
          "flex justify-between items-center py-3 px-4 border-b dark:border-gray-700",
        ),
        v(d, "class", "text-gray-800 dark:text-gray-400"),
        v(a, "class", "p-4 overflow-y-auto"),
        v(D, "type", "button"),
        v(
          D,
          "class",
        ...
        v(D, "data-hs-overlay", "#hs-vertically-centered-modal"),
        v(
          m,
          "class",
  ...
  return (
    (r.$$set = (l) => {
      "message" in l && n(0, (t = l.message)),
        "buttonLabel" in l && n(1, (o = l.buttonLabel)),
    ...
    (d = wr(r[7][0])),
    {
      c() {
        (e = E("div")),
          ...
          (c.textContent = `${r[11]}`),
          (a = Z()),
          v(t, "id", "hs-radio-" + r[10]),
          (t.__value = r[10]),
          bt(t, t.__value),
          v(t, "name", "hs-radio-with-description"),
          v(t, "type", "radio"),
          v(
            t,
            "class",
          ...
          v(t, "aria-describedby", "hs-radio-delete-description"),
          v(n, "class", "flex items-center h-5 mt-1"),
          v(
            s,
            "class",
            "block text-sm font-semibold text-gray-800 dark:text-gray-300",
          ),
          v(c, "id", "hs-radio-ddl-description"),
          v(c, "class", "block text-sm text-gray-600 dark:text-gray-500"),
          v(i, "for", "hs-radio-" + r[10]),
          v(i, "class", "ml-3"),
          v(e, "class", "relative flex items-start"),
          d.p(t);
      },
      m(x, D) {
        U(x, e, D),
  ...
  return {
    c() {
      ...
      (k = Z()),
        ...
        v(a, "class", "block mb-2 text-sm font-medium dark:text-white"),
        v(g, "class", "grid space-y-3 mb-1"),
        v(D, "for", "hs-feedback-post-comment-textarea-1"),
        v(D, "class", "block mt-2 mb-2 text-sm font-medium dark:text-white"),
        v(_, "id", "hs-feedback-post-comment-textarea-1"),
        v(_, "name", "hs-feedback-post-comment-textarea-1"),
        v(_, "rows", "3"),
        v(
          _,
          "class",
        ...
        v(
          ...
          "placeholder",
          (A =
            ((j = r[3].find(r[8])) == null ? void 0 : j.example) ??
            "No example available"),
        ),
        v(p, "class", "mt-1"),
        v(x, "class", "mt-2 border-t dark:border-gray-700"),
        v(
          u,
          "class",
    ...
    p(j, [R]) {
      ...
      R & 1 && Ue(m, r[0]),
        R & 1 &&
          A !==
            (A =
              ((q = r[3].find(r[8])) == null ? void 0 : q.example) ??
              "No example available") &&
          v(_, "placeholder", A),
        R & 4 && bt(_, r[2]);
    },
...
function ii(r, e, n) {
  let { onDismiss: t } = e,
    { onTrain: o } = e,
    { selectedTrainingDataType: i = "SQL" } = e,
    s = [
      {
        name: "DDL",
        description:
          "These are the CREATE TABLE statements that define your database structure.",
        example:
      ...
      },
      {
        name: "Documentation",
        description:
          "This can be any text-based documentation. Keep the chunks small and focused on a single topic.",
        example: "Our definition of ABC is XYZ.",
      },
      {
        name: "SQL",
        description:
          "This can be any SQL statement that works. The more the merrier.",
  ...
  return (
    (r.$$set = (x) => {
      "onDismiss" in x && n(1, (t = x.onDismiss)),
        "onTrain" in x && n(5, (o = x.onTrain)),
        "selectedTrainingDataType" in x &&
          n(0, (i = x.selectedTrainingDataType));
    }),
    [i, t, l, s, c, o, d, a, g, k]
  );
}
...
function Kn(r) {
  let e, n;
  return (
    (e = new si({ props: { onDismiss: r[13], onTrain: r[0] } })),
    {
      c() {
        J(e.$$.fragment);
      },
  ...
  return {
    c() {
      Te && Te.c(),
        ...
        (g = E("div")),
        (k = E("button")),
        (k.textContent = "View all"),
        (x = Z()),
        (D = E("button")),
        (D.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2.63452 7.50001L13.6345 7.5M8.13452 13V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>
                    Add training data`),
        (L = Z()),
        (m = E("table")),
        (h = E("thead")),
      ...
      (P = Z()),
        ...
        (ie = Z()),
        (re = E("p")),
        (re.textContent = `of ${r[7].length}`),
        (Ye = Z()),
        (Ae = E("div")),
        (De = E("div")),
        (Ve = E("button")),
        (Ve.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"></path></svg>
                    Prev`),
        (lt = Z()),
        (me = E("button")),
        (me.innerHTML = `Next
        ...
        v(g, "class", "inline-flex gap-x-2"),
        v(
          l,
          "class",
          "px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700",
        ),
        v(h, "class", "bg-gray-50 dark:bg-slate-800"),
        v(A, "class", "divide-y divide-gray-200 dark:divide-gray-700"),
        v(
          m,
          "class",
          "min-w-full divide-y divide-gray-200 dark:divide-gray-700",
        ),
        v(f, "class", "text-sm text-gray-600 dark:text-gray-400"),
        v(
          S,
          "class",
        ...
        v(C, "class", "max-w-sm space-y-3"),
        v(re, "class", "text-sm text-gray-600 dark:text-gray-400"),
        v(u, "class", "inline-flex items-center gap-x-2"),
        v(Ve, "type", "button"),
        v(
          Ve,
          "class",
        ...
        v(De, "class", "inline-flex gap-x-2"),
        v(
          T,
          "class",
        ...
        v(i, "class", "p-1.5 min-w-full inline-block align-middle"),
        v(o, "class", "-m-1.5 overflow-x-auto"),
        v(t, "class", "flex flex-col"),
        v(
          n,
          "class",
          "max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto",
    ...
    p(X, [He]) {
      if (
        (X[6]
          ? Te
            ? (Te.p(X, He), He & 64 && M(Te, 1))
            : ((Te = Kn(X)), Te.c(), M(Te, 1), Te.m(e.parentNode, e))
          : Te &&
            (Ne(),
            I(Te, 1, 1, () => {
              Te = null;
        ...
        for (oe = 0; oe < ct.length; oe += 1) {
          ...
          Pe[oe]
            ? Pe[oe].p(gt, He)
            : ((Pe[oe] = Xn(gt)), Pe[oe].c(), Pe[oe].m(p, null));
        }
      ...
      if (He & 304) {
        ...
        for (oe = 0; oe < Be.length; oe += 1) {
          ...
          Oe[oe]
            ? Oe[oe].p(gt, He)
            : ((Oe[oe] = tr(gt)), Oe[oe].c(), Oe[oe].m(A, null));
        }
        for (; oe < Oe.length; oe += 1) Oe[oe].d(1);
        Oe.length = Be.length;
      }
      (!at || He & 4) && j !== (j = X[2] + 1 + "") && Ue(R, j),
        (!at || He & 8) &&
          B !== (B = Math.min(X[3], X[7].length) + "") &&
          Ue(N, B),
        X[5] != null
          ? Le
            ? (Le.p(X, He), He & 32 && M(Le, 1))
            : ((Le = nr(X)), Le.c(), M(Le, 1), Le.m(ze.parentNode, ze))
          : Le &&
            (Ne(),
            I(Le, 1, 1, () => {
              Le = null;
...
function di(r, e, n) {
  let { df: t } = e,
    { onTrain: o } = e,
    { removeTrainingData: i } = e,
    s = JSON.parse(t),
    l = s.length > 0 ? Object.keys(s[0]) : [],
    c = 10,
    a = 1,
    d = Math.ceil(s.length / c),
    g = (a - 1) * c,
    k = a * c,
    x = s.slice(g, k);
  const D = () => {
  ...
  return (
    (r.$$set = (f) => {
      "df" in f && n(14, (t = f.df)),
        "onTrain" in f && n(0, (o = f.onTrain)),
        "removeTrainingData" in f && n(1, (i = f.removeTrainingData));
    }),
    (r.$$.update = () => {
      r.$$.dirty & 98304 && n(2, (g = (a - 1) * c)),
        r.$$.dirty & 98304 && n(3, (k = a * c)),
        r.$$.dirty & 12 && n(4, (x = s.slice(g, k))),
        r.$$.dirty & 32768 && n(17, (d = Math.ceil(s.length / c))),
        r.$$.dirty & 196608 && console.log(a, d);
    }),
...
class pi extends Se {
  constructor(e) {
    super(),
      $e(this, e, di, fi, xe, { df: 14, onTrain: 0, removeTrainingData: 1 });
  }
}
function gi(r) {
  let e;
...
function mi(r) {
  let e, n;
  return (
    (e = new fr({ props: { message: r[0].error } })),
    {
      c() {
        J(e.$$.fragment);
      },
...
function yi(r) {
  ...
  return (
    (e = new pi({
      props: { df: r[0].df, removeTrainingData: r[1], onTrain: r[2] },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function vi(r, e, n) {
  let { trainingData: t } = e,
    { removeTrainingData: o } = e,
    { onTrain: i } = e;
  return (
    (r.$$set = (s) => {
      "trainingData" in s && n(0, (t = s.trainingData)),
        "removeTrainingData" in s && n(1, (o = s.removeTrainingData)),
        "onTrain" in s && n(2, (i = s.onTrain));
    }),
    [t, o, i]
  );
}
...
function wi(r) {
  ...
  return (
    (e = new _i({
      props: { trainingData: r[3], removeTrainingData: r[14], onTrain: r[15] },
    })),
    {
      c() {
        J(e.$$.fragment);
...
function ki(r) {
  ...
  return (
    r[4] !== void 0 && (a.question_asked = r[4]),
    r[5] !== void 0 && (a.thinking = r[5]),
    r[0] !== void 0 && (a.marked_correct = r[0]),
    (e = new ei({ props: a })),
    At.push(() => on(e, "question_asked", s)),
    At.push(() => on(e, "thinking", l)),
    At.push(() => on(e, "marked_correct", c)),
    {
      c() {
        J(e.$$.fragment);
      },
      ...
      p(d, g) {
        const k = {};
        g & 4 && (k.suggestedQuestions = d[2]),
          g & 2 && (k.messageLog = d[1]),
          !n &&
            g & 16 &&
            ((n = !0), (k.question_asked = d[4]), nn(() => (n = !1))),
          !t && g & 32 && ((t = !0), (k.thinking = d[5]), nn(() => (t = !1))),
          !o &&
            g & 1 &&
            ((o = !0), (k.marked_correct = d[0]), nn(() => (o = !1))),
          e.$set(k);
      },
      i(d) {
...
function Si(r, e, n) {
  ...
  function k(q) {
    g(),
      _({ type: "user_question", question: q }),
      n(4, (s = !0)),
      f("generate_sql", "GET", { question: q })
        .then(_)
        .then((B) => {
          B.type === "sql" &&
            ...
            f("run_sql", "GET", { id: B.id })
              ...
              .then((N) => {
                N.type === "df" &&
                  f("generate_plotly_figure", "GET", { id: N.id })
                    .then(_)
                    .then((ie) => {
                      ie.type === "plotly_figure" &&
                        (n(7, (d = [...d, { question: q, id: ie.id }])),
  ...
  function x(q) {
    _({ type: "user_question", question: "Re-run the SQL" }),
      f("run_sql", "GET", { id: q })
        .then(_)
        .then((B) => {
          B.type === "df" &&
            f("generate_plotly_figure", "GET", { id: B.id })
              .then(_)
              .then((N) => {
                N.type === "plotly_figure" &&
                  f("generate_followup_questions", "GET", { id: N.id }).then(_);
              });
        });
  }
  function D() {
  ...
  function m() {
    (window.location.hash = ""),
      n(6, (a = "chat")),
      g(),
      o || f("generate_questions", "GET", []).then(P);
  }
  function h(q) {
    (window.location.hash = q),
      ...
      g(),
      n(4, (s = !0)),
      f("load_question", "GET", { id: q }).then(_);
  }
  function p(q) {
    n(3, (i = null)),
      f("remove_training_data", "POST", { id: q }).then((B) => {
        f("get_training_data", "GET", []).then(A);
      });
  }
  function _(q) {
  ...
  async function f(q, B, N) {
    try {
      ...
      if (B === "GET")
        (ie = Object.entries(N)
          .filter(([Ae, De]) => Ae !== "endpoint" && Ae !== "addMessage")
          .map(
            ([Ae, De]) => `${encodeURIComponent(Ae)}=${encodeURIComponent(De)}`,
          )
          .join("&")),
          (re = await fetch(`/api/v0/${q}?${ie}`));
      else {
  ...
  function C(q) {
    ...
    if (B && B.type === "user_question") {
      ...
      f("train", "POST", N),
        n(1, (t = t.filter((ie) => ie.type !== "user_sql"))),
        _({ type: "sql", text: q, id: window.location.hash });
    }
  }
  function S(q) {
    (s = q), n(4, s);
